...
typedef struct
{
  ...
  RIL_PinState     pin1;
  RIL_PinState     pin2;
  int              pin1_num_retries;      /* Samsung */
  int              puk1_num_retries;      /* Samsung */
  int              pin2_num_retries;      /* Samsung */
  int              puk2_num_retries;      /* Samsung */
  int              perso_unblock_retries; /* Samsung */
} RIL_AppStatus;
...
#define RIL_UNSOL_RESPONSE_HANDOVER 11029
